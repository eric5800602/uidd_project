...
$.ajax({
    ...
    success: function(data){
      ...
      var category_html=`<p class="content_category_title">Category</p>\
                        ...
                        <p class="content_category_content_first content_category_content_content"  id="category_1" click="category(this.id)"> ${data.post.space} </p>\
                        <p class="content_category_content_big">> </p>\
                        <p class="content_category_content_second content_category_content_content" id="category_2" click="category(this.id)"> ${data.post.room}</p>\
                        <p class="content_category_content_big">></p>\
                        <p class="content_category_content_third content_category_content_content" id="category_3" click="category(this.id)"> ${data.post.pings}</p>\
                        `;
