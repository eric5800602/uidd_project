  ...
  $("#addsingle").on('click', function () {
   ...
   // $("#original" + editNum).removeClass("mouseAxis");
    ...
    if(!axisX||!axisY||!document.getElementById(`original${editNum}`).childNodes[0].getAttribute('src')){
      ...
      var temp = editNum;
      targety = -parseInt(document.getElementById(`original${temp}`).childNodes[0].style.top)+parseInt(window.getComputedStyle(document.getElementById("myimage")).getPropertyValue("padding-top"))+39;
